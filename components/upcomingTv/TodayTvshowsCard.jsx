...
const TodayTvshowsCard = ({movie}) => {
    return (
        <Link href={`/tvdetails/${movie.id}`} passHref className="w-full h-full">
          <div className="w-full h-full border p-2 border-gray-500">
            ...
            <div className="py-2 text-center">
              ...
              <p className="text-center text-sm text-blue-500">release date: {movie.first_air_date}</p>
...
export default TodayTvshowsCard